...
the zero-travel reference point. The polynomial implementation is retained
in `poly_gen/cheby.py` as the source of truth for the table values,
if the sensor transfer curve ever changes, regenerate
