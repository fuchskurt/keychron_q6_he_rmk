...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        layer!(
            // Layer 0: WIN_BASE
        [
            [k!(Escape),    k!(F1),    k!(F2),    k!(F3),    k!(F4),    k!(F5),    k!(F6),    k!(F7),    k!(F8),    k!(F9),    k!(F10),       k!(F11),   k!(F12),   k!(AudioMute), k!(PrintScreen), a!(No), a!(No), k!(F13), k!(F14), k!(F15), k!(F16)],
            ...
            [k!(CapsLock),  k!(A),     k!(S),     k!(D),     k!(F),     k!(G),     k!(H),     k!(J),     k!(K),     k!(L),     k!(Semicolon), k!(Quote), a!(No), k!(Enter), a!(No), a!(No), a!(No), a!(No), k!(Kp4), k!(Kp5), k!(Kp6)],
            [k!(LShift),    a!(No),    k!(Z),     k!(X),     k!(C),     k!(V),     k!(B),     k!(N),     k!(M),     k!(Comma), k!(Dot),       k!(Slash), a!(No), k!(RShift), a!(No), k!(Up), a!(No), k!(Kp1), k!(Kp2), k!(Kp3), k!(KpEnter)],
            [k!(LCtrl),     k!(LGui),  k!(LAlt),  a!(No),    a!(No),    a!(No),    k!(Space), a!(No),    a!(No),    a!(No),    k!(RAlt),      k!(RGui),  a!(No), k!(RCtrl), k!(Left), k!(Down), k!(Right), k!(Kp0), a!(No), a!(No), k!(KpDot)]
        ]),
    ]
}
